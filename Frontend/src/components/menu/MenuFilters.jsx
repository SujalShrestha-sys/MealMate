...
const MenuFilters = ({ activeCategory, setActiveCategory, categories, searchQuery, setSearchQuery }) => {
    return (
        <div id="menu-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 scroll-mt-24">
