...
const MenuCard = ({ product, quantity = 0, updateQuantity }) => {
    return (
        <div className="relative group pt-12 h-full">
            <div className="bg-white rounded-[2rem] p-6 shadow-lg shadow-slate-200/50 hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-300 h-full flex flex-col border border-slate-100 relative group-hover:-translate-y-2">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-50 mt-auto">
                        ...
                        {quantity === 0 ? (
                            ...
                            <div className="flex items-center gap-3 bg-green-50 p-1 rounded-full border border-green-100 shadow-sm animate-fade-in">
                                ...
                                <span className="text-green-700 font-bold min-w-[1.25rem] text-center">
                                    {quantity}
                                </span>
                                <button
                                    onClick={() => updateQuantity(product.id, 1)}
